...
type _CreateUserSuccess CreateUserSuccess
...
func (o *CreateUserSuccess) UnmarshalJSON(data []byte) (err error) {
	varCreateUserSuccess := _CreateUserSuccess{}

	err = json.Unmarshal(data, &varCreateUserSuccess)

	if err != nil {
		return err
	}

	*o = CreateUserSuccess(varCreateUserSuccess)
