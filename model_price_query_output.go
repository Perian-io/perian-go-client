...
// checks if the PriceQueryOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceQueryOutput{}

// PriceQueryOutput Query for the price attribute.
type PriceQueryOutput struct {
	Operator NullableOperator `json:"operator,omitempty"`
	Options NullableQueryOptions `json:"options,omitempty"`
	All *bool `json:"all,omitempty"`
	UnitPrice NullableString `json:"unit_price,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PriceQueryOutput PriceQueryOutput
...
func (o *PriceQueryOutput) SetOperatorNil() {
	o.Operator.Set(nil)
}
...
func (o *PriceQueryOutput) SetOptionsNil() {
	o.Options.Set(nil)
}
...
func (o *PriceQueryOutput) SetUnitPriceNil() {
	o.UnitPrice.Set(nil)
}
...
func (o PriceQueryOutput) MarshalJSON() ([]byte, error) {
...
func (o PriceQueryOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PriceQueryOutput) UnmarshalJSON(data []byte) (err error) {
	varPriceQueryOutput := _PriceQueryOutput{}

	err = json.Unmarshal(data, &varPriceQueryOutput)

	if err != nil {
		return err
	}

	*o = PriceQueryOutput(varPriceQueryOutput)
...
type NullablePriceQueryOutput struct {
	value *PriceQueryOutput
	isSet bool
}

func (v NullablePriceQueryOutput) Get() *PriceQueryOutput {
	return v.value
}

func (v *NullablePriceQueryOutput) Set(val *PriceQueryOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceQueryOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceQueryOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceQueryOutput(val *PriceQueryOutput) *NullablePriceQueryOutput {
	return &NullablePriceQueryOutput{value: val, isSet: true}
}

func (v NullablePriceQueryOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceQueryOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
