...
// checks if the StorageQueryInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageQueryInput{}

// StorageQueryInput Query for the storage attribute.
type StorageQueryInput struct {
...
func (o *StorageQueryInput) SetOperatorNil() {
	o.Operator.Set(nil)
}
...
func (o *StorageQueryInput) SetOptionsNil() {
	o.Options.Set(nil)
}
...
func (o *StorageQueryInput) SetNoNil() {
	o.No.Set(nil)
}
...
func (o *StorageQueryInput) SetSizeNil() {
	o.Size.Set(nil)
}
...
func (o *StorageQueryInput) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *StorageQueryInput) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
func (o *StorageQueryInput) SetIncludedNil() {
	o.Included.Set(nil)
}
...
func (o StorageQueryInput) MarshalJSON() ([]byte, error) {
...
func (o StorageQueryInput) ToMap() (map[string]interface{}, error) {
...
type NullableStorageQueryInput struct {
	value *StorageQueryInput
	isSet bool
}

func (v NullableStorageQueryInput) Get() *StorageQueryInput {
	return v.value
}

func (v *NullableStorageQueryInput) Set(val *StorageQueryInput) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageQueryInput) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageQueryInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageQueryInput(val *StorageQueryInput) *NullableStorageQueryInput {
	return &NullableStorageQueryInput{value: val, isSet: true}
}

func (v NullableStorageQueryInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageQueryInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
