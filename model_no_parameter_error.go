...
// checks if the NoParameterError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NoParameterError{}

// NoParameterError Error response for missing Job id.
...
type _NoParameterError NoParameterError
...
func NewNoParameterError() *NoParameterError {
	this := NoParameterError{}
	var status string = "Error"
	this.Status = &status
	var message string = "Operation failed due to a client error"
	this.Message = &message
	var detail string = "Please provide a specific job ID."
	this.Detail = &detail
...
func (o NoParameterError) MarshalJSON() ([]byte, error) {
...
func (o NoParameterError) ToMap() (map[string]interface{}, error) {
...
func (o *NoParameterError) UnmarshalJSON(data []byte) (err error) {
	varNoParameterError := _NoParameterError{}

	err = json.Unmarshal(data, &varNoParameterError)

	if err != nil {
		return err
	}

	*o = NoParameterError(varNoParameterError)
...
type NullableNoParameterError struct {
	value *NoParameterError
	isSet bool
}

func (v NullableNoParameterError) Get() *NoParameterError {
	return v.value
}

func (v *NullableNoParameterError) Set(val *NoParameterError) {
	v.value = val
	v.isSet = true
}

func (v NullableNoParameterError) IsSet() bool {
	return v.isSet
}

func (v *NullableNoParameterError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNoParameterError(val *NoParameterError) *NullableNoParameterError {
	return &NullableNoParameterError{value: val, isSet: true}
}

func (v NullableNoParameterError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNoParameterError) UnmarshalJSON(src []byte) error {
	v.isSet = true
