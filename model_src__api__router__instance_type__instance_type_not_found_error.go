...
// checks if the SrcApiRouterInstanceTypeInstanceTypeNotFoundError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcApiRouterInstanceTypeInstanceTypeNotFoundError{}

// SrcApiRouterInstanceTypeInstanceTypeNotFoundError Error when the instance type is not found.
type SrcApiRouterInstanceTypeInstanceTypeNotFoundError struct {
...
func NewSrcApiRouterInstanceTypeInstanceTypeNotFoundError() *SrcApiRouterInstanceTypeInstanceTypeNotFoundError {
	this := SrcApiRouterInstanceTypeInstanceTypeNotFoundError{}
	var status string = "Error"
	this.Status = &status
	var message string = "Operation failed due to a client error"
	this.Message = &message
	var detail string = "No instance type found with specified ID"
	this.Detail = &detail
...
func (o SrcApiRouterInstanceTypeInstanceTypeNotFoundError) MarshalJSON() ([]byte, error) {
...
func (o SrcApiRouterInstanceTypeInstanceTypeNotFoundError) ToMap() (map[string]interface{}, error) {
...
type NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError struct {
	value *SrcApiRouterInstanceTypeInstanceTypeNotFoundError
	isSet bool
}

func (v NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) Get() *SrcApiRouterInstanceTypeInstanceTypeNotFoundError {
	return v.value
}

func (v *NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) Set(val *SrcApiRouterInstanceTypeInstanceTypeNotFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError(val *SrcApiRouterInstanceTypeInstanceTypeNotFoundError) *NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError {
	return &NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError{value: val, isSet: true}
}

func (v NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcApiRouterInstanceTypeInstanceTypeNotFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
