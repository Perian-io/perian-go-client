...
// APIClient manages communication with the FastAPI API v0.2.8
...
type APIClient struct {
	...
	AcceleratorTypeAPI *AcceleratorTypeAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AcceleratorTypeAPI = (*AcceleratorTypeAPIService)(&c.common)
